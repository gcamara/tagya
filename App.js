...
export default function App() {
  ...
  const handleCmd = useCallback(async (msg) => {
    ...
    try {
      ...
      if (msg.cmd === 'scan') {
        // Ack imediato (antes de qualquer await): sinaliza ao WebView que o nativo recebeu.
        ...
        // allowDuplicates:true re-reporta devices mesmo que o iOS já os tenha visto num
        // scan anterior — sem isso a lista pode vir vazia. Paramos qualquer scan antes.

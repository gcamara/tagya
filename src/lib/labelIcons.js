...
export const ICONS = {
  ...
  // ---- Animais ----
  cat: (c, x, y, s) => { prep(c, s); poly(c, x, y, s, [[0.3, 0.4], [0.24, 0.14], [0.44, 0.32]], true, true); poly(c, x, y, s, [[0.7, 0.4], [0.76, 0.14], [0.56, 0.32]], true, true); circle(c, x, y, s, 0.5, 0.58, 0.3, false); circle(c, x, y, s, 0.4, 0.54, 0.028, true); circle(c, x, y, s, 0.6, 0.54, 0.028, true); poly(c, x, y, s, [[0.46, 0.62], [0.54, 0.62], [0.5, 0.68]], true, true); line(c, x, y, s, 0.16, 0.58, 0.34, 0.6); line(c, x, y, s, 0.16, 0.64, 0.34, 0.64); line(c, x, y, s, 0.84, 0.58, 0.66, 0.6); line(c, x, y, s, 0.84, 0.64, 0.66, 0.64); c.restore() },
  dog: (c, x, y, s) => { prep(c, s); rrect(c, x, y, s, 0.13, 0.32, 0.18, 0.36, 0.08, false); rrect(c, x, y, s, 0.69, 0.32, 0.18, 0.36, 0.08, false); circle(c, x, y, s, 0.5, 0.56, 0.28, false); circle(c, x, y, s, 0.4, 0.52, 0.028, true); circle(c, x, y, s, 0.6, 0.52, 0.028, true); circle(c, x, y, s, 0.5, 0.62, 0.045, true); line(c, x, y, s, 0.5, 0.66, 0.5, 0.72); arc(c, x, y, s, 0.44, 0.72, 0.06, 0, Math.PI, false); arc(c, x, y, s, 0.56, 0.72, 0.06, 0, Math.PI, false); c.restore() },
  lion: (c, x, y, s) => { prep(c, s); for (let i = 0; i < 12; i++) { const a = (Math.PI * 2 * i) / 12; line(c, x, y, s, 0.5 + 0.29 * Math.cos(a), 0.54 + 0.29 * Math.sin(a), 0.5 + 0.44 * Math.cos(a), 0.54 + 0.44 * Math.sin(a)) } circle(c, x, y, s, 0.5, 0.54, 0.29, false); circle(c, x, y, s, 0.41, 0.5, 0.028, true); circle(c, x, y, s, 0.59, 0.5, 0.028, true); poly(c, x, y, s, [[0.45, 0.58], [0.55, 0.58], [0.5, 0.64]], true, true); arc(c, x, y, s, 0.43, 0.65, 0.07, 0, Math.PI, false); arc(c, x, y, s, 0.57, 0.65, 0.07, 0, Math.PI, false); c.restore() },
  elephant: (c, x, y, s) => { prep(c, s); circle(c, x, y, s, 0.52, 0.42, 0.26, false); arc(c, x, y, s, 0.27, 0.42, 0.18, Math.PI * 1.25, Math.PI * 0.6, false); c.beginPath(); c.moveTo(x + 0.5 * s, y + 0.66 * s); c.bezierCurveTo(x + 0.52 * s, y + 0.9 * s, x + 0.74 * s, y + 0.88 * s, x + 0.7 * s, y + 0.62 * s); c.stroke(); circle(c, x, y, s, 0.5, 0.38, 0.025, true); line(c, x, y, s, 0.64, 0.64, 0.68, 0.78); c.restore() },
  giraffe: (c, x, y, s) => { prep(c, s); rrect(c, x, y, s, 0.36, 0.56, 0.34, 0.22, 0.05, false); poly(c, x, y, s, [[0.5, 0.6], [0.58, 0.2], [0.7, 0.2], [0.64, 0.6]], true, false); rrect(c, x, y, s, 0.6, 0.12, 0.2, 0.12, 0.04, false); line(c, x, y, s, 0.65, 0.12, 0.64, 0.05); circle(c, x, y, s, 0.64, 0.04, 0.022, true); line(c, x, y, s, 0.75, 0.12, 0.76, 0.05); circle(c, x, y, s, 0.76, 0.04, 0.022, true); line(c, x, y, s, 0.44, 0.78, 0.44, 0.92); line(c, x, y, s, 0.64, 0.78, 0.64, 0.92); circle(c, x, y, s, 0.48, 0.64, 0.028, true); circle(c, x, y, s, 0.58, 0.7, 0.028, true); c.restore() },
  crocodile: (c, x, y, s) => { prep(c, s); poly(c, x, y, s, [[0.06, 0.56], [0.16, 0.48], [0.26, 0.56], [0.36, 0.48], [0.48, 0.54], [0.62, 0.5]], false, false); poly(c, x, y, s, [[0.62, 0.5], [0.94, 0.54], [0.94, 0.62], [0.62, 0.62], [0.06, 0.56]], true, false); circle(c, x, y, s, 0.58, 0.47, 0.045, false); circle(c, x, y, s, 0.58, 0.47, 0.016, true); line(c, x, y, s, 0.7, 0.62, 0.72, 0.68); line(c, x, y, s, 0.8, 0.62, 0.82, 0.68); line(c, x, y, s, 0.3, 0.6, 0.28, 0.72); line(c, x, y, s, 0.52, 0.6, 0.54, 0.72); c.restore() },
  fish: (c, x, y, s) => { prep(c, s); c.beginPath(); c.moveTo(x + 0.66 * s, y + 0.5 * s); c.bezierCurveTo(x + 0.5 * s, y + 0.24 * s, x + 0.2 * s, y + 0.34 * s, x + 0.14 * s, y + 0.5 * s); c.bezierCurveTo(x + 0.2 * s, y + 0.66 * s, x + 0.5 * s, y + 0.76 * s, x + 0.66 * s, y + 0.5 * s); c.stroke(); poly(c, x, y, s, [[0.66, 0.5], [0.9, 0.34], [0.86, 0.5], [0.9, 0.66]], true, false); circle(c, x, y, s, 0.28, 0.46, 0.025, true); c.restore() },
  bird: (c, x, y, s) => { prep(c, s); c.beginPath(); c.arc(x + 0.46 * s, y + 0.52 * s, 0.24 * s, Math.PI * 1.1, Math.PI * 0.4, false); c.stroke(); poly(c, x, y, s, [[0.64, 0.4], [0.86, 0.32], [0.7, 0.5]], true, true); poly(c, x, y, s, [[0.7, 0.46], [0.84, 0.5], [0.7, 0.54]], true, true); circle(c, x, y, s, 0.7, 0.42, 0.016, true); line(c, x, y, s, 0.42, 0.72, 0.42, 0.86); line(c, x, y, s, 0.54, 0.72, 0.54, 0.86); c.restore() },
  owl: (c, x, y, s) => { prep(c, s); rrect(c, x, y, s, 0.22, 0.2, 0.56, 0.64, 0.26, false); poly(c, x, y, s, [[0.24, 0.28], [0.32, 0.1], [0.42, 0.24]], true, false); poly(c, x, y, s, [[0.76, 0.28], [0.68, 0.1], [0.58, 0.24]], true, false); circle(c, x, y, s, 0.38, 0.42, 0.1, false); circle(c, x, y, s, 0.62, 0.42, 0.1, false); circle(c, x, y, s, 0.38, 0.42, 0.03, true); circle(c, x, y, s, 0.62, 0.42, 0.03, true); poly(c, x, y, s, [[0.46, 0.5], [0.54, 0.5], [0.5, 0.58]], true, true); c.restore() },
  rabbit: (c, x, y, s) => { prep(c, s); rrect(c, x, y, s, 0.34, 0.06, 0.1, 0.36, 0.05, false); rrect(c, x, y, s, 0.56, 0.06, 0.1, 0.36, 0.05, false); circle(c, x, y, s, 0.5, 0.62, 0.24, false); circle(c, x, y, s, 0.42, 0.58, 0.025, true); circle(c, x, y, s, 0.58, 0.58, 0.025, true); circle(c, x, y, s, 0.5, 0.66, 0.03, true); c.restore() },
  bear: (c, x, y, s) => { prep(c, s); circle(c, x, y, s, 0.28, 0.3, 0.12, false); circle(c, x, y, s, 0.72, 0.3, 0.12, false); circle(c, x, y, s, 0.5, 0.56, 0.32, false); circle(c, x, y, s, 0.4, 0.5, 0.028, true); circle(c, x, y, s, 0.6, 0.5, 0.028, true); circle(c, x, y, s, 0.5, 0.62, 0.06, false); circle(c, x, y, s, 0.5, 0.6, 0.025, true); c.restore() },
  turtle: (c, x, y, s) => { prep(c, s); arc(c, x, y, s, 0.5, 0.58, 0.3, Math.PI, 0, false); line(c, x, y, s, 0.2, 0.58, 0.8, 0.58); circle(c, x, y, s, 0.5, 0.56, 0.16, false); circle(c, x, y, s, 0.85, 0.54, 0.07, false); line(c, x, y, s, 0.28, 0.66, 0.24, 0.78); line(c, x, y, s, 0.5, 0.7, 0.5, 0.8); line(c, x, y, s, 0.72, 0.66, 0.76, 0.78); c.restore() },
  butterfly: (c, x, y, s) => { prep(c, s); line(c, x, y, s, 0.5, 0.24, 0.5, 0.76); circle(c, x, y, s, 0.33, 0.4, 0.16, false); circle(c, x, y, s, 0.67, 0.4, 0.16, false); circle(c, x, y, s, 0.35, 0.66, 0.12, false); circle(c, x, y, s, 0.65, 0.66, 0.12, false); line(c, x, y, s, 0.5, 0.24, 0.42, 0.13); line(c, x, y, s, 0.5, 0.24, 0.58, 0.13); c.restore() },
  snake: (c, x, y, s) => { prep(c, s); c.beginPath(); c.moveTo(x + 0.82 * s, y + 0.24 * s); c.bezierCurveTo(x + 0.3 * s, y + 0.2 * s, x + 0.72 * s, y + 0.5 * s, x + 0.32 * s, y + 0.58 * s); c.bezierCurveTo(x + 0.06 * s, y + 0.64 * s, x + 0.22 * s, y + 0.86 * s, x + 0.6 * s, y + 0.82 * s); c.stroke(); circle(c, x, y, s, 0.84, 0.24, 0.06, false); circle(c, x, y, s, 0.85, 0.22, 0.014, true); line(c, x, y, s, 0.9, 0.26, 0.97, 0.24); c.restore() },
  paw: (c, x, y, s) => { prep(c, s); circle(c, x, y, s, 0.3, 0.34, 0.09, true); circle(c, x, y, s, 0.5, 0.28, 0.09, true); circle(c, x, y, s, 0.7, 0.34, 0.09, true); circle(c, x, y, s, 0.5, 0.64, 0.18, true); c.restore() }
}
...
export const ICON_CATEGORIES = [
  ...
  { id: 'animais', name: 'Animais', keys: ['cat', 'dog', 'lion', 'elephant', 'giraffe', 'crocodile', 'fish', 'bird', 'owl', 'rabbit', 'bear', 'turtle', 'butterfly', 'snake', 'paw'] },
